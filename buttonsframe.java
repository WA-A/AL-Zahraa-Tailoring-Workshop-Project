...
public class buttonsframe extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tabledataemp1.getColumnModel().getSelectionModel().setSelectionMode(javax.swing.ListSelectionModel.SINGLE_INTERVAL_SELECTION);
    ...
    private void tabledataempMouseMoved(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabledataempMouseMoved
     ...
     try {
      ...
      String colhead[]={"BUTTON_SHAPE","BUTTON_SIZES"};
      model.setColumnIdentifiers(colhead);
      Statement stmt = con.createStatement();
      ResultSet rs = stmt.executeQuery("select * from BUTTON_SIZES");
    ...
    private void tabledataemp1MouseMoved(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabledataemp1MouseMoved
     ...
     try {
      ...
      String url ="jdbc:oracle:thin:@localhost:1521:xe";
      Connection con=DriverManager.getConnection(url,"c##batool","654321");
      String colhead[]={"BUTTON_SHAPE","BUTTON_AMOUNT"};
      model.setColumnIdentifiers(colhead);
      Statement stmt = con.createStatement();
      ResultSet rs = stmt.executeQuery("select * from BUTTONS");
      ResultSetMetaData rsmd = rs.getMetaData();
      int cols = rsmd.getColumnCount();
      while(rs.next()){
    ...
    private void jButton2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton2MouseClicked
       buttonoperation lgf = new buttonoperation();
