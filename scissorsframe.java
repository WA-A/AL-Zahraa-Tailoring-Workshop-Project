 ...
 * @author TestEnv
 */
public class scissorsframe extends javax.swing.JFrame {

    /**
     * Creates new form scissorsframe
     */
    public scissorsframe() {
        initComponents();
    }
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
         ...
         addscissors lgf = new addscissors();
        lgf.setVisible(true);
        lgf.pack();
    ...
    private void tabledataempMouseMoved(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabledataempMouseMoved
     ...
     try {
      ...
      String colhead[]={"SCISSOR_SIZE","SCISSOR_AMOUNT"};
      model.setColumnIdentifiers(colhead);
      Statement stmt = con.createStatement();
      ResultSet rs = stmt.executeQuery("select * from SCISSORS");
    ...
    private void jButton2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton2MouseClicked
        scissoroperation lgf = new scissoroperation();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(scissorsframe.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new scissorsframe().setVisible(true);
            }
        });
    }
